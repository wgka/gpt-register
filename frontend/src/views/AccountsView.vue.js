...
async function runCheckBanAll() {
    try {
        await ElMessageBox.confirm('将对所有账号进行封号检测，封禁/失效账号将被直接删除，是否继续？', '全量检测封号', { type: 'warning' });
    }
    catch {
        return;
    }
...
const __VLS_120 = __VLS_asFunctionalComponent1(__VLS_119, new __VLS_119({
    ...
    type: "danger",
    plain: true,
    loading: (__VLS_ctx.batchAction === 'check-ban'),
}));
...
const __VLS_125 = ({ click: {} },
    { onClick: (__VLS_ctx.runCheckBanAll) });
const { default: __VLS_126 } = __VLS_122.slots;
// @ts-ignore
[batchAction, runCheckBanAll,];
var __VLS_122;
var __VLS_123;
__VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)({
...
let __VLS_132;
const __VLS_133 = ({ selectionChange: {} },
...
{
    const { default: __VLS_171 } = __VLS_168.slots;
    const [{ row }] = __VLS_vSlot(__VLS_171);
...
let __VLS_244;
const __VLS_245 = ({ currentChange: {} },
    { onCurrentChange: (__VLS_ctx.handlePageChange) });
const __VLS_246 = ({ sizeChange: {} },
